...
2. `/src`: 含leetcode, mini stl, ml库
   1. `_alg`: **leetcode库**的算法实现. leetcode库使用**leetcode**命名空间. 
      1. `_array.h`: euclidean_dist, manhattan_dist, partial_sum_lc, bracket_matching, two_sum, get_vv_size, flatten_vv, fib, intersection, random_select, random_select2
      ...
      6. `_sort.h`: gen_randint, three_way_partition, partition_lc, quick_sort, quick_sort2, merge_sort, bubble_sort, select_sort, insert_sort, count_sort
...
## 性能
1. 100%: 1, 19, 20, 21, 51, 52, 70, 92, 94, 102, 144, 145, 509, 700, 876, 912, 2248, O_40
